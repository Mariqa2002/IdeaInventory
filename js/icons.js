...
const PATHS = {
  ...
  cloud: '<path d="M17.5 19H7a4.5 4.5 0 0 1-.6-8.96 6 6 0 0 1 11.5 1.66A3.65 3.65 0 0 1 17.5 19z"/>',
  cloudCheck: '<path d="M17.5 18H7a4.5 4.5 0 0 1-.6-8.96 6 6 0 0 1 11.5 1.66A3.65 3.65 0 0 1 17.5 18z"/><path d="M9.6 13.4l1.9 1.9 3.4-3.6"/>',
  cloudOff: '<path d="M3 3l18 18"/><path d="M8.9 5.6A6 6 0 0 1 17.9 11.7 3.65 3.65 0 0 1 19.8 18M16 19H7a4.5 4.5 0 0 1-.6-8.96c.07-.4.18-.78.32-1.14"/>',
  users: '<circle cx="9" cy="8" r="3.4"/><path d="M2.8 20a6.2 6.2 0 0 1 12.4 0"/><path d="M16.5 5.2a3.4 3.4 0 0 1 0 6.6M18 14.4a6.2 6.2 0 0 1 3.2 5.6"/>',
};
